...
public abstract class BaseQuickAdapter<T, K extends BaseViewHolder> extends RecyclerView.Adapter<K> {
    ...
    @Override
    public void onBindViewHolder(K holder, int positions, List<Object> payloads) {
        ...
        switch (viewType) {
            case 0:
                if (payloads == null || payloads.isEmpty())
                    ...
                    convertByPosition(holder, mData.get(holder.getLayoutPosition() - getHeaderLayoutCount()), payloads.get(0));
                break;
            case LOADING_VIEW:
    ...
    protected void convertByPosition(K helper, T item, Object paylod) {
